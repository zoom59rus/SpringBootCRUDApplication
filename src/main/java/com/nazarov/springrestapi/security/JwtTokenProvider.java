...
public class JwtTokenProvider {
    ...
    public boolean validateToken(String token){
        try {
            ...
            throw new JwtAuthenticationException("JWT token is invalid or expiration.", HttpStatus.UNAUTHORIZED);
        }
    }

    public Authentication authentication(String token){
        UserDetails userDetails = accountDetailsService.loadUserByUsername(getLogin(token));
